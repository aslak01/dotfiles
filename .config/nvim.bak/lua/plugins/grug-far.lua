      ...
      opts = {
        mappings = {
          n = {
            ...
            [prefix .. "e"] = {
              function()
                local ext = require("astrocore.buffer").is_valid()
                    and vim.fn.expand "%:e"
                  or ""
                grug_far_open {
            ...
            [prefix .. "f"] = {
              function()
                local filter = require("astrocore.buffer").is_valid()
                    and vim.fn.expand "%"
                  or nil
          ...
          x = {
            [prefix] = {
              function() grug_far_open(nil, true) end,
      ...
      opts = {
        keymaps = {
          S = {
            ...
            callback = function()
              grug_far_open {
                prefills = { paths = require("oil").get_current_dir() },
              }
            end,
          },
        },
